        ...
        protected void convert(BaseViewHolder helper, String item) {
            ...
            if (datalist.size() == 1){
                if (titleTv.getVisibility() == View.VISIBLE){
                    helper.setBackgroundRes(R.id.item_layout,R.drawable.common_bg_bottom_ioswhite_8t);
                }else {
                    helper.setVisible(R.id.item_lineview,false);
                    helper.setBackgroundRes(R.id.item_layout,R.drawable.common_bg_ios_white_8t);
                }
            }else if (helper.getAdapterPosition() == 0){ //第一个 item
                if (titleTv.getVisibility() == View.VISIBLE){
                    helper.setBackgroundRes(R.id.item_layout,R.color.ios_white);
                }else {
                    helper.setBackgroundRes(R.id.item_layout,R.drawable.common_bg_top_ioswhite_8t);
                    helper.setVisible(R.id.item_lineview,false);
                }
